    ...
    >
      <q-card-section class="col-md-6 col-12">
        ...
        <form @submit.prevent="handleFormSubmit">
          ...
          <div class="q-gutter-md">
            ...
            <div class="flex justify-center q-mb-lg">
              ...
              <router-link class="text-bold text-primary" style="text-decoration: none;" :to="{ name: 'ForgotPasswordPage' }">{{
                $t('pages.public.login.forgotPassword')
              }}</router-link>
            </div>
          </div>
        ...
        <div class="flex column justify-center items-center q-mt-md">
          <p>
            {{ $t('pages.public.login.notUser') }}
            <router-link class="text-bold text-primary" style="text-decoration: none;" :to="{ name: 'RegisterPage' }">{{
              $t('pages.public.login.registerHere')
            }}</router-link>
          </p>
        </div>
