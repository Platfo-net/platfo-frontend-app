...
const { mutateAsync, isPending: createChatbotIsPending } =
  chatbotService.mutations.createChatbot();
/****************** */
...
<template>
  <q-dialog
    v-model="showCreateChatbotDialog"
    @hide="
      (x) =>
        (createChatbotModel = {
          name: '',
      ...
      <q-card-section>
        <q-form
          ...
          <q-btn
            ...
            color="primary"
            label="ایجاد"
            :loading="createChatbotIsPending"></q-btn>
        </q-form>
      </q-card-section>
    </q-card>
  </q-dialog>
  <q-page class="q-pa-md container">
    ...
    <div class="row justify-between items-center q-mb-lg">
      <div class="text-h5">چت بات های من</div>
      <q-btn
        color="dark"
        label="ایجاد چت بات جدید"
        @click="showCreateChatbotDialog = true"></q-btn>
    </div>
    <div v-if="!chatBotListLoading" class="row q-col-gutter-md">
      <div
        v-for="chatbot in chatbotList"
        :key="chatbot.uuid"
